...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "6k_ZTFYoke1lfAGy1x9r";
	private final static String CLIENT_SECRET = "dovYYoLAGN";
	private final static String REDIRECT_URI = "http://3.128.94.224/callback.do";

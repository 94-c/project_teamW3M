...
public class OrderVO {
	...
	public String toString() {
		return "OrderVO [order_seq=" + order_seq + ", order_date=" + order_date + ", order_status=" + order_status
				...
				+ ", user_address2=" + user_address2 + ", user_level=" + user_level + ", receiver_name=" + receiver_name
				+ ", receiver_phone1=" + receiver_phone1 + ", receiver_phone2=" + receiver_phone2
				+ ", receiver_zipcode=" + receiver_zipcode + ", receiver_address1=" + receiver_address1
				+ ", receiver_address2=" + receiver_address2 + ", receiver_memo=" + receiver_memo + ", prod_code="
				+ prod_code + ", prod_seq=" + prod_seq + ", prod_amount=" + prod_amount + ", prod_title=" + prod_title
				+ ", prod_title_image=" + prod_title_image + ", prod_price=" + prod_price + ", prod_price_sale="

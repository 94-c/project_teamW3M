...
<link href="resources/css/orderDetail.css" rel="stylesheet"
	type="text/css">
<link href="resources/css/common.css" rel="stylesheet" type="text/css">
<link href="resources/css/main.css" rel="stylesheet" type="text/css">
<link href="resources/css/adminOrderDetail.css" rel="stylesheet"
	type="text/css">
				...
				<div id="orderSt">
					<div class="tit-pop">
						...
						<span class="txt"><em class="order_name">${userInfo.user_name}</em>님께서
							<em class="order_date"><fmt:formatDate
									value="${deliveryInfo.order_date}"
									pattern="yyyy년 MM월 dd일 a h시 mm분" /></em>에 주문하신 내역입니다.</span>
					</div>
					<ul class="tab">
						<li><a href="#">주문상세</a></li>
					</ul>
								...
								<tbody>
									<tr>
										...
										<td><div class="tb-left">
												<fmt:formatDate value="${deliveryInfo.order_date}"
							...
							<table summary="">
								...
								<tfoot>
									<tr>
										<td colspan="8">
											<div class="tb-right">
												(총 상품구매금액 + 배송비) - (사용한 적립금(${payInfo.pay_use_point} point)
												+ 멤버십 추가할인(${salePercent}%)) =
												<fmt:formatNumber value="${payInfo.pay_total_money}"
													pattern="#,###" />
												원
											</div>
										</td>
										...
										<tr>
											...
											<td><div class="tb-center tb-price">
													<strong><fmt:formatNumber
															value="${opi.prod_price_sale * opi.prod_amount}"
															pattern="#,###" /></strong>
												</div></td>
											<td><div class="tb-center">
													<span class="style4"><fmt:formatNumber
															value="${opi.prod_point * opi.prod_amount}"
															pattern="#,###" /></span>
												</div></td>
							...
							<table class="table_purchase">
								...
								<tbody>
									<tr>
										...
										<td><div class="tb-center">${payInfo.pay_use_point}
												point</div></td>
									</tr>
									<tr>

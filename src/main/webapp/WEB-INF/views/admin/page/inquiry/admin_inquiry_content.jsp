		...
		<form name="fileForm" action="insertReply.mdo" method="post">
			...
			<div class="card mb-4">
				<div class="card-header">
					<i class="fas fa-table mr-1"></i> ${inquiryVO.inq_title }
				</div>
				<div class="card-body">
					<div class="table-responsive">
						<table>
							...
							<tbody>
								...
								<tr>
									<td><pre>
											<div class="data-bd-cont">${inquiryVO.inq_content }</div>
										</pre></td>
								</tr>
							</tbody>
						</table>
						...
						<input type="hidden" id="inq_seq" name="inq_seq"
							value="${inquiryVO.inq_seq}" />

						<div>
							<input type="hidden" id="re_writer" name="re_writer" value="관리자" />
							<br />
							<textarea id="reply_text" name="re_content"
								placeholder="댓글을 입력하세요" onfocus="this.placeholder=''"
								onblur="this.placeholder='댓글을 입력하세요'" style="font-family: 굴림체;"></textarea>
							<br> <input type="submit" value="등록" class="CSSbuttonBlack"
								id="replybutton" />
						</div>

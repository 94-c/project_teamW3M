...
<div class="container-fluid">
	...
	<div class="card mb-4">
		...
		<div class="card-body">
			<div id="product_chart_gender"
				style="width: auto; height: 500px; display: inline-block;"></div>
			<div id="product_chart_level"
				style="width: auto; height: 500px; display: inline-block;"></div>
			<div id="product_chart_top5"
				style="width: auto; height: 500px; display: inline-block;"></div>
			<div id="product_chart_bottom5"
				style="width: auto; height: 500px; display: inline-block;"></div>
		</div>
	</div>
	<!-- body end -->

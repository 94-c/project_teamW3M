	...
	<div class="container-fluid">
		<h1 class="mt-4">상품 관리 페이지</h1>
			<p>※ 상품코드 작성법<p>
				...
				<p>3단계 : L:대형 / M:중형 / S:소형 / XS:초소형 / J:점보(핫팩) / P:포켓(핫팩) / X:구분없음</p>
				<p>4단계 : 94:KF-94 / 80:KF-80 / AD:KF-AD(비말차단) / ETH:손소독제 / X:구분없음</p>
				<p>5단계 : 50:50개입 / 25:25개입 / 30:30개입(비말차단) / 1:손소독제 / 기타:1B, 3B, 20, 30, 1</p>
			<p>※ 상품명 작성법</p>
		...
		<div class="card mb-4">
			...
			<form role="form" method="post" name="writeform"
				enctype="multipart/form-data" action="insertProduct.mdo"
				...
				<div class="card-body">
					...
					<div class="form-group">
						<label for="exampleFormControlInput1">상품 대표이미지</label><br>
...
(상품명 예시: W3M 프리미엄 미세먼지마스크 KF94 대형 25개입)"></textarea></pre>
					</div>
					<table id="example">
						<tr>

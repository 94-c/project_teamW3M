		...
		<div id="content">
			<div id="bbsData">
				<div class="page-body">
					...
					<div align="right">
						<input type="button" value="글 수정" class="CSSbuttonBlack"
							...
							id="contentbutton" onclick="location.href='./review.do'" /> <input
							type="button" value="글 쓰기" class="CSSbuttonBlack"
							id="contentbutton"
							onclick="location.href='./review_write_view.do'" />
					</div>
					<br> <br> <br> <br>
				</div>
				...
				<div id="reply">
					...
					<table id="re_table">
						<c:forEach items="${reviewReplyList}" var="reviewList">
							...
							<c:set var="user_review_id"
								value="${reviewList.review_re_writer }" />
				...
				<form id="comment_form" name="comment"
					action="insertReviewReply.do?prod_code=${reviewVO.prod_code}"
					method="post">
										...
										<div>
											<div class="wrt">
												<label>아이디</label> <span> <input type="text"
													name="review_re_writer"
													class="MS_input_txt input-style input-style2"
													value="${userVO.user_id}" placeholder="아이디"></span>
											</div>
											<div class="wrt wrt_write"><pre><textarea name="review_re_content" placeholder="내용"></textarea></pre>

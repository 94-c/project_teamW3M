							...
							<table border="1" summary="No, content,Name,Date,Hits">
								...
								<tbody>
									<c:forEach var="reviewVO" items="${reviewList}">
                                        ...
                                        <c:if test="${reviewVO.reply_cnt <=0}">
                                        <td><div class="tb-left"><a href='<c:url value='/reviewContent.do?review_seq=${reviewVO.review_seq}'/>'class="text-dark">[${reviewVO.prod_title}]${reviewVO.review_title}</a></div>
                                        </td>
                                        </c:if>
                                        <td>

								...
								<tbody>
									<c:forEach var="reviewVO" items="${reviewList}">
                                        ...
                                        <td><div class="tb-left">&nbsp;</div></td>
                                       	<td><div class="tb-left"><img src="${reviewVO.prod_title_image}" width="60" height="60" align="middle"></div></td> 
                                        <c:if test="${reviewVO.reply_cnt > 0}">
                                        <td><div class="tb-left"><a href='<c:url value='/reviewContent.do?review_seq=${reviewVO.review_seq}&prod_title=${reviewVO.prod_title }'/>'class="text-dark"><strong>[${reviewVO.prod_title}]</strong>&nbsp;&nbsp;${reviewVO.review_title}</a><a href="javascript:void(window.open('review_reply.do?review_seq=${reviewVO.review_seq}', '_blank','width=430px, height=340px, status=no, menubar=no, toolbar=no, resizable=no'))">[${reviewVO.reply_cnt}]</a></div>
                                        </td>
                                        </c:if>
                                        <c:if test="${reviewVO.reply_cnt <=0}">
                                        <td><div class="tb-left"><a href='<c:url value='/reviewContent.do?review_seq=${reviewVO.review_seq}&prod_title=${reviewVO.prod_title }'/>'class="text-dark"><strong>[${reviewVO.prod_title}]</strong>&nbsp;&nbsp;${reviewVO.review_title}</a></div>
                                        </td>
                                        </c:if>
                                        <td>

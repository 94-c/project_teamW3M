							...
							<table border="1" summary="No, content,Name,Date,Hits">
								...
								<tbody>
									<c:forEach var="reviewVO" items="${reviewList }">
                                        ...
                                        <td><div class="tb-left"><a href='<c:url value='/reviewContent.do?review_seq=${reviewVO.review_seq}'/>'class="text-dark">[${product.prod_title}]${reviewVO.review_title}[${recnt}]</a></div>
                                        </td>
                                        <td>

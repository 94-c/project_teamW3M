									...
									<tr>
										<div class="title">
											<td><label for="title">제목</label><input type="text"
												...
												class="MS_input_txt input_style1" value="${getInquiry.inq_title}" /></td>
									</tr>
									<tr>
										<td><label for="writer">작성자</label><input type="text"
											id="bw_input_writer" name="inq_writer"
											class="MS_input_txt input_style1" value="${getInquiry.inq_writer}" /></td>
									</tr>

									<tr>
										<td><label for="content">내용</label> <textarea
												id="inq_content" name="inq_content">${getInquiry.inq_content}</textarea></td>
									</tr>
									<tr>
										<td>

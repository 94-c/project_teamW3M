...
<body>
	<link type="text/css" rel="stylesheet" href="resources/css/join_simple.css?t=202012241313" />
	<link type="text/css" rel="stylesheet" href="resources/css/new_join49b3.css?t=201712060950" />
      <link type="text/css" rel="stylesheet" href="resources/css/common.css?r=1512521415" />
   ...
   <div id="wrap">
      <link href='resources/css/nanumgothic.css'  rel='stylesheet' type='text/css'>
      <link href="https://fonts.googleapis.com/css?family=Roboto:400,700" rel="stylesheet">
      <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700"   rel="stylesheet">


      <script type="text/javascript" src="resources/css/header.js?t=202012220932"></script>
      <div id="contentWrapper">
         <div id="contentWrap">
            <link type="text/css" rel="stylesheet"  href="resources/css/menu.15700.css?t=201912021906" />
            <div id="content">
               <div id="join_test">
                  ...
                  <div id="personInfo">
                     <table class="person-tb">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="col-cell">
                                 <input type="text" name="user_name" id="hname" value=""
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="col-cell">
                                 <input type="text" name="user_id" size="10" maxlength="12" />
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="col-cell">
                                 ...
                                 <span class="idpw-info"> * 영문 대소문자/숫자/특수문자를 혼용하여 2종류
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="col-cell social">
                                 ...
                                 <input type="radio" name="user_sex" value="여자" checked />여
                              </div>
                           </td>
                        </tr>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="col-cell">
                                 <input type="text" name="#" form="join_form" id="hpost"
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="col-cell">
                                 <input type="text" name="#" form="join_form"
                        ...
                        <tr>
                           ...
                           <td>
                              ...
                              <select name="user_phone2">	
                                 ...
                                 <input type="text" name="user_phone2" form="join_form"
                                    size="6" maxlength="10" value="" /> -
                                 <input type="text" name="user_phone3" form="join_form"
                                    size="6" maxlength="10" value="" />
                              </div>
                           </td>
                        </tr>
                        <tr>
                           ...
                           <td>
                              <div class="col-cell email-area">
                                 <input type="text" name="user_email1" id="email1"size="10" maxlength="20" value="" /> <span>@</span> 
                                    <span id="direct_email" style="margin-top: 3px; display: inline-block"> 
                                    	<input  type="text" name="user_email3" id="email3"
                                    	class="MS_input_txt normal-input" value="" size="15"
                                    	maxlength="25" onchange="this.form.emailcheck.value=''" />
                                 	</span> 
                                 	<select name="user_email2" id="email2" class="MS_select MS_email" style="margin-right: 5px;" onchange="viewdirect()">
                  ...
                  <fieldset>
                     ...
                     <div class="new-privercy-contract">
                           ...
                           <div class="cont p10">
                              <ul>
                                 ...
                                 <li class="ml-30 pt-10"><label><input
                                       ...
                                       value="agree_uidB" class="input-cbox every_agree" /> 개인정보
                                       수집 및 이용 안내</label> <a href="#chk_cont2">내용보기</a></li>
                        ...
                        <div class="privercy-contract">
                           <textarea cols="80" wrap="off" rows="10" readonly>인터넷 쇼핑몰 『 웰킵스(주) 사이버 몰』회원 약관


제1조(목적)
이 약관은 웰킵스(주) 회사(전자상거래 사업자)가 운영하는 웰킵스(주) 사이버 몰(이하 "몰"이라 한다)에서 
...
제2조(정의)
①"몰" 이란 웰킵스(주) 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴
...
번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 웰킵스(주) 사이버몰의 초기 서비스화면(전면)
...
⑤ “몰”은 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률‘ 제 29조(개인정보의 파기)에 따라 1년 이상 
로그인 하지 않은 휴면고객님의 계정을 삭제 처리 합니다. 삭제시 계정 내 개인정보 및 적립금이 삭제됩니다.
...
제25조(적립금)
①   구입하는 이용자에게 경품, 사은품 등의 목적으로 이용자에게 적립금을 부여할 수 있으며, 적립금의 부여 및 사용 등과 관련한 사항은 이 약관 또는 운영정책이 정한 바에 따릅니다.
②   적립금은 상품 구매 시 현금 가액과 동일하게 사용할 수 있으나 사용을 제한한 품목에는 사용할 수 없으며, 현금으로 교환할 수 없습니다.
③   적립금의 소멸시효는 24개월을 원칙으로 하되, 사전에 기간을 정하여 지급하는 적립금은 사전에 고지된 기간을 소멸시효로 봅니다.
④   적립금은 부여된 순서로 사용되며, 제3자에게 양도할 수 없습니다. 동일 소유 복수 계정간 양도 불가
⑤   적립금의 사용 한도 및 적립은 품목, 기간, 행사에 따라 변동 될 수 있으며, 특정 상품 또는 행사 시 적립금의 사용 및 적립이 제외 될 수 있습니다.
                        ...
                        <table border="0" summary="구분, 목적, 항목, 보유기간, 필수정보, 선택정보"
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td><div class="p10 itemsY">이름, 아이디, 비밀번호, 생일, 성별,
                                       이메일, 주소, 연락처, 휴대폰</div></td>
